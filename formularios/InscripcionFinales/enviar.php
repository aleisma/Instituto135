...
//traigo todos los alumnos inscriptos por carrera segun el DNI
   $dni=  $_POST['dni'];
    ...
    $sql="SELECT DISTINCT a.apellido,a.nombre,ca.nombre_carrera FROM inscripciones i INNER JOIN alumnos a ON a.DNI = '$dni'
    ...
    AND i.ID_Carrera = c.ID_Carrera ";
      $result=mysqli_query($conexion,$sql);
        //materias cursadas, nota>=4, asistencia>=60 segun DNI...
       $m1=getMateriasFinales($dni);
...
<input type="text" class="form-control" value="<?php echo $_POST['dni'];?>" id="dni" readonly>
</div></div>
<div class="col-3">
<div class="input-group mb-2">
<div class="input-group-prepend">
...
<p><em> <u>Nota:</u> El alumno aprobo la cursada de las siguientes materias:</em></p>
...
function agregarDatos(materias,anio)
{
    ...
    var  ins=$('#ins').val();
    cadena="materias=" + materias +"&inicio=" + inicio +"&ins="+ ins+"&anio="+ anio +"&dni="+ dni;
